...
import GridItemForGallery from "./gallery/GridItemForGallery";
...
const Gallery = () => {
  return (
    <div className="wrapper image-container my-20 overflow-hidden ">
      <div className="text-center mb-10 flex flex-col gap-5">
        <span className="font-medium tracking-widest">{`LET'S SEE`}</span>
        <span className="section-title">GALLERY OF ALIBABA</span>
        <Link
          href="/products"
